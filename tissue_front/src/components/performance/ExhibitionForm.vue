<template>
  <div>
    <v-container style="width: 1300px">
      <v-row>
        <v-col>
          <div class="mainTitle">E X H I B I T I O N</div>
          ...
          <div class="countBox">
            현재 예매가능한 공연은
            <b style="color: skyblue">{{ exhibitionList.length }}개</b>
            입니다.
          </div>
        </v-col>
      </v-row>
...
export default {
  ...
  data() {
    return {
      originalData: [...this.exhibitionList],
      copyData: this.exhibitionList,
    };
  },
  methods: {
    sortOrig() {
